...
// {
//     internal abstract class ExoticFruitsModFruit : ModItem
//     {
...
//         {
//             return player.statLifeMax >= ExoticFruits.LifeRequired && player.statManaMax >= ExoticFruits.ManaRequired && player.GetModPlayer<ExoticFruitsPlayer>().modFruitsConsumed[modFruitIndex] < ExoticFruits.MaxFruits;
//         }
...
//             player.GetModPlayer<ExoticFruitsPlayer>().modFruitsConsumed[modFruitIndex]++;
//             return true;
//         }
...
//                     }
//                     else if (player.modFruitsConsumed[modFruitIndex] < ExoticFruits.MaxFruits)
//                     {
//                         line.OverrideColor = null;
//                         line.IsModifier = true;
//                     }
...
//                         if (player.modFruitsConsumed[modFruitIndex] > ExoticFruits.MaxFruits)
//                         {
//                             capped += $" > {maxFruits}/{maxFruits}"; // Consumed: 2/1 > 1/1
//                         }

//                     }
//                     newLine = line.Text.Replace("<consumed>", player.modFruitsConsumed[modFruitIndex].ToString());
