...
{
    internal class ExoticFruits20 : ExoticFruitsCalamityFruit
    {
        private readonly int calamityFruitIndex = 9;
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("HellcasterFragment").Type, 1);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("HellcasterFragment").Type, 1);
            }
        }
    }
}