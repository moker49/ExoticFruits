...
{
    internal class ExoticFruits15 : ExoticFruitsCalamityFruit
    {
        private readonly int calamityFruitIndex = 4;
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("DarkPlasma").Type, 1);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("DarkPlasma").Type, 1);
            }
        }
    }
}