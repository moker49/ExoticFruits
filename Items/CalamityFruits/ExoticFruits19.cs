...
{
    internal class ExoticFruits19 : ExoticFruitsCalamityFruit
    {
        private readonly int calamityFruitIndex = 8;
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("CosmiliteBar").Type, 5);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("CosmiliteBar").Type, 5);
            }
        }
    }
}