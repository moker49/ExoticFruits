...
{
    internal class ExoticFruits18 : ExoticFruitsCalamityFruit
    {
        private readonly int calamityFruitIndex = 7;
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("MutatedTruffle").Type, 1);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("MutatedTruffle").Type, 1);
            }
        }
    }
}