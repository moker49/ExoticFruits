...
{
    internal class ExoticFruits14 : ExoticFruitsCalamityFruit
    {
        private readonly int calamityFruitIndex = 3;
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("ArmoredShell").Type, 1);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("ArmoredShell").Type, 1);
            }
        }
    }
}