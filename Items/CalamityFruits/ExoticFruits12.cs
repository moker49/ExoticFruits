...
namespace ExoticFruits.Items.CalamityFruits
{
    internal class ExoticFruits12 : ExoticFruitsCalamityFruit
    {
        ...
        public override void AddRecipes()
        {
            ...
            {
                base.CreateFinalRecipe(ItemID.LifeFruit, calamityMod.Find<ModItem>("EffulgentFeather").Type, 10);
            }
            if (ExoticFruits.enableCrystalRecipes)
            {
                base.CreateFinalRecipe(ItemID.LifeCrystal, calamityMod.Find<ModItem>("EffulgentFeather").Type, 10);
            }
        }
    }
}